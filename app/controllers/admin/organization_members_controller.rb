class Admin::OrganizationMembersController < AdminController
  ...
  def create
    @organization_member = OrganizationMember.new(organization_id: params[:organization_member][:organization], registered_user_id: params[:organization_member][:registered_user])
  ...
  def organization_member_params
    params.fetch(:organization_member, {}).permit(:organization_member)
  end
end