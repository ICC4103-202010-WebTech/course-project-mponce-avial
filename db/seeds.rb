user1 = RegisteredUser.create(name: "Andres", last_name: "Vial", age: 21, email_address: "avial5@miuandes.cl", google_account: "", password:”asdf”, location: “Santiago”)
user2 = RegisteredUser.create(name: "Matias", last_name: "Ponce", age: 21, email_address: "maponce@miuandes.cl", google_account: "", password:”sdfg”, location: “Santiago”)
user3 = RegisteredUser.create(name: "Jojo", last_name: "Smith", age: 22, email_address: "maponce@miuandes.cl", google_account: "", password:”sdfg”, location: “Santiago”)
user4 = RegisteredUser.create(name: "Julio", last_name: "Castro", age: 28, email_address: "juliojaja@miuandes.cl", google_account: "", password:”toda”, location: “Valparaiso”)
