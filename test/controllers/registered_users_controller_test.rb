...
class RegisteredUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get new" do
    get new_registered_user_url
    assert_response :success
  end

  test "should create registered_user" do
    assert_difference('RegisteredUser.count') do
      post registered_users_url, params: { registered_user: {  } }
    end

    assert_redirected_to registered_user_url(RegisteredUser.last)
  end
  ...
  test "should get edit" do
    get edit_registered_user_url(@registered_user)
    assert_response :success
  end

  test "should update registered_user" do
    patch registered_user_url(@registered_user), params: { registered_user: {  } }
    assert_redirected_to registered_user_url(@registered_user)
  end
  ...
  test "should destroy registered_user" do
    ...
    assert_redirected_to registered_users_url
  end
end
